...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('quan-tri.order.index')}}">DS Đơn Hàng</a></li>
        </ol>
    </section>
    @if (session('msg'))
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <form action="{{ route('quan-tri.order.update', ['id' => $order->id]) }}" method="post">
                        @csrf
                        @method('PUT')
...
{{--                        {{dd($order->details)}}--}}
                            <!-- Lặp một mảng dữ liệu pass sang view để hiển thị -->
                                ...
                                <td class="cart-delete text-center">
                                    <a data-id="{{$item->product_id }}" href="javascript:void(0)"
        ...
        $(function () {
            ...
            $(document).on("click", '.remove-to-cart', function () {
                ...
                if (result) {
                    ...
                    $.ajax({
                        url: '/quan-tri/order/remove-to-cart',
                        type: 'post',
                        data: {
                            order_id : order_id,
