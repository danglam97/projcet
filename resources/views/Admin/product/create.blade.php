...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Thêm mới sản phẩm <a href="{{route('quan-tri.product.index')}}" class="btn btn-flat btn-success pull-right "><i
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('quan-tri.product.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
